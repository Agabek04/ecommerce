<template>
  <div class="min-h-screen bg-gray-50 p-4 sm:p-6">
    <h1
      class="text-3xl sm:text-4xl font-extrabold text-center mb-6 sm:mb-10 text-gray-900"
    >
      Admin Panel
    </h1>

    <div
      class="flex flex-col sm:flex-row justify-center gap-3 sm:gap-6 mb-6 sm:mb-8"
    >
      <button
        ...
        <table class="w-full border-collapse text-gray-700 min-w-[500px]">
          ...
          <tbody>
            ...
            >
              ...
              <td
                class="py-3 px-5 flex justify-center gap-2 sm:gap-3 flex-wrap"
              >
                <button
                  v-if="editCategoryId === category.id"
